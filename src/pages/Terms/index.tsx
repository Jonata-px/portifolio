    ...
    <section className="terms">
      <div className="container">
        ...
        <ol>
          <li>
            <span>
              ...
              jfcoder.com/promotion_game_alert/terms's website for personal,
          ...
          <li>
            <span>
              ...
              jfcoder.com/promotion_game_alert/terms website;
            </span>
          </li>
          <li>
            <span>
          ...
          <li>
            <span>
              ...
              jfcoder.com/promotion_game_alert/terms at any time. Upon
        ...
        <ol>
          <li>
            <span>
              The materials on jfcoder.com/promotion_game_alert/terms's
              website are provided on an 'as is' basis.
              jfcoder.com/promotion_game_alert/terms makes no warranties,
          ...
          <li>
            <span>
              Further, jfcoder.com/promotion_game_alert/terms does not
        ...
        <p>
          <span>
            In no event shall jfcoder.com/promotion_game_alert/terms or its
            ...
            jfcoder.com/promotion_game_alert/terms's website, even if
            jfcoder.com/promotion_game_alert/terms or a
            jfcoder.com/promotion_game_alert/terms authorised representative
        ...
        <p>
          <span>
            ...
            jfcoder.com/promotion_game_alert/terms's website could include
            technical, typographical, or photographic errors.
            jfcoder.com/promotion_game_alert/terms does not warrant that any
            of the materials on its website are accurate, complete or current.
            jfcoder.com/promotion_game_alert/terms may make changes to the
            materials contained on its website at any time without notice.
            However jfcoder.com/promotion_game_alert/terms does not make any
        ...
        <p>
          <span>
            jfcoder.com/promotion_game_alert/terms has not reviewed all of
            ...
            imply endorsement by jfcoder.com/promotion_game_alert/terms of
        ...
        <p>
          <span>
            jfcoder.com/promotion_game_alert/terms may revise these terms of
        ...
        <p>
          <span>
            ...
            jfcoder.com/promotion_game_alert/terms and you irrevocably submit
