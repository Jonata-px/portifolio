...
export default function Privaity() {
  return (
      ...
      <div className="container">
        ...
        <p>
          <span>
            ...
            jfcoder.com.br/w2estacionamento/terms's policy to respect your
        ...
        <p>
          <span>
            <h2>
              <span>
                Cookie Policy for jfcoder.com.br/w2estacionamento/terms
              </span>
            </h2>
            <p>
              <span> </span>
            ...
            <p>
              <span>
                ...
                jfcoder.com.br/w2estacionamento/terms, accessible from URL
                jfcoder.com.br/w2estacionamento/terms.
              </span>
            </p>
            <p>
        ...
        <h3>
          <span>User's responsibilities</span>
        </h3>
        <p>
          <span>
        ...
        <ul>
          ...
          <li>
            <span>
              ...
              ERROR or gambling nature, any type of illegal pornography,
              terrorist claims or against human rights;
            </span>
          </li>
          <li>
            <span>
              ...
              jfcoder.com.br/w2estacionamento/terms, its suppliers or third
        ...
        <p>
          <span>This policy is effective as of 20 April 2023 12:42.</span>
        </p>
      </div>
    </section>
  );
